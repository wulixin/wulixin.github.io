...
(function(){
try {
   var timings = [ { marker: 'knitr', elapsed: 3970 }, { marker: 'pandoc', elapsed: 170 }, { marker: 'post-processor', elapsed: 10 }, { marker: 'pre-processor', elapsed: 0 }, { marker: 'render', elapsed: 5530 } ];
