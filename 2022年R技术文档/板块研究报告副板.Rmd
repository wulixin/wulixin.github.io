...
stocks_name<-stocks_names%>%
  filter(name %in% c("雅创电子","汇通集团","华亚智能","迎丰股份",              "德业股份","保立佳","宝鹰股份","深南股份","粤宏远A","人人乐","财信发展",'安正时尚'))
...
tm <- treemap(treemap_data, index = c("category","name"),
              ...
              type = "value", palette = rev(viridis(6)),title="投资回报全景视图")
```
...
ggcorrplot(corr, hc.order = TRUE, 
           ...
           ggtheme=theme_hildaDusk(ticks = TRUE,
                  legend.position = "none"))
```
